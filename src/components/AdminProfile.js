            ...
            <Container>
                ...
                <div className="main">
                    <Left>
                        ...
                        <Link to="/admin/dashboard/profile" className="left-item active">
                                ...
                                <div className="details">
                                    ...
                                    <div className="ipt-imgs">
                                        <div className="adhaar">
                                            <img src="https://i.pinimg.com/originals/f9/9b/3e/f99b3efadece9bde10e251760cc71b1c.jpg" alt="" />
                                        </div>
                                        <div className="passport">
                                            <img src="https://live.staticflickr.com/8599/16337413461_9e83d5af7d_z.jpg" alt="" />
                                        </div>
                                        <div className="passport">
                                            <img src="https://i.ytimg.com/vi/CgcU4zKm0Bc/maxresdefault.jpg" alt="" />
                                        </div>
                                    </div>
