                    ...
                    <Right>
                        ...
                        <div className="general">
                            <div className="card">
                                ...
                                <div className="desc">This canteen can provide to with food anyday, in specific hours - <b>8:00hrs to 23:00 hrs</b>.
                                  <br />  <a> 9306183174</a></div>
                            </div>
                            <div className="card rjt-card">
                                <div className="card-top">
                                    <p>Nayak Food Service</p>
                                    <MoreVertIcon className="icon" />
                                </div>
                                <div className="card-mid">
                                    <img src="https://abskitchen.co.in/onlineorder/img/defLogo.png?1537453188" alt="" />
                                </div>
                                <div className="status">Currently Closed</div>
                                <div className="desc">This canteen can provide to with food anyday, in specific hours - <b>8:00hrs to 23:00 hrs</b>.
                                  <br />  <a> 9306183174</a></div>
                            </div>
                            {/* code */}
