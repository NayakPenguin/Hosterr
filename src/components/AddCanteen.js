                        ...
                        <div className="general">
                            <div className="grand-card">
                                ...
                                <div className="details">
                                    <input type="number" className="detail" placeholder="Canteen Name"/>
                                    <div className="two-details">
                                        {/* <input type="text" className="detail" placeholder="Room No."/> */}
                                        <div className="time-select">
                                            <p>Opening Time</p>
                                            <input className="taketime" type="time"/>
                                        </div>
                                        <div className="time-select">
                                            <p>Closing Time</p>
                                            <input className="taketime" type="time"/>
                                    ...
                                    <input type="number" className="detail" placeholder="Canteen Contact Number"/>
                                    {/* <input type="text" className="detail" placeholder="Room No."/>
                                    <div className="two-details">
