                                    ...
                                    <div className="grand-card">
                                        ...
                                        <div className="details2">
                                            <div className="detail">
                                                ...
                                                <p className="res">Very low food quality </p>
                                            </div>
                                            <div className="detail">
                                                <p className="cat">Content : </p>
                                                <p className="res">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Asperiores, tempora iusto? Iste, nesciunt cumque. Sunt tempora quam delectus! Rerum atque consectetur cupiditate, eius nostrum illo dolor! Cum quo eius consequuntur deserunt dolor quae commodi vero molestias odio atque, cupiditate, quos perferendis impedit voluptate doloribus, ducimus nam recusandae quia omnis facilis! </p>
                                            </div>
                                            <div className="reply">
                                    ...
                                    <div className="grand-card">
                                        ...
                                        <div className="details">
                                            <div className="detail detail-header">
                                                ...
                                                <div className="fees">Date</div>
                                            </div>
                                            <div className="detail">
                                                <div className="room-no">1</div>
                                                <div className="hostel-name">Change my roommate</div>
                                                <a className="resident" onClick={() => setShowInbox(true)}>
                                                    <>View Detailed</>
                                                    <OpenInNewIcon className="icon" /></a>
                                                <div className="fees"> 14 Feb, 22</div>
                                            </div>
                                            <div className="detail">
                                                <div className="room-no">2</div>
                                                <div className="hostel-name">No room service</div>
                                                <a className="resident" onClick={() => setShowInbox(true)}>
                                                    <>View Detailed</>
                                                    <OpenInNewIcon className="icon" /></a>
                                                <div className="fees"> 27 Jan, 22</div>
                                            </div>
                                            <div className="detail">
                                                <div className="room-no">3</div>
                                                <div className="hostel-name">Very low food quality</div>
                                                <a className="resident" onClick={() => setShowInbox(true)}>
                                                    <>View Detailed</>
                                                    <OpenInNewIcon className="icon" /></a>
                                                <div className="fees"> 10 Jan, 22</div>
                                            </div>
                                        </div>
                                    </div>
